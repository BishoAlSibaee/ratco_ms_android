...
public class MyApproval_AdvancePayment_Adapter extends RecyclerView.Adapter<MyApproval_AdvancePayment_Adapter.HOLDER>
{
    ...
    private String responseAdvanceUrl = "https://ratco-solutions.com/RatcoManagementSystem/getAdvancePaymentsForApproval.php";
    boolean[] status ;


    public MyApproval_AdvancePayment_Adapter(List<ADVANCEPAYMENT_CLASS> list) {
        this.list = list;
    ...
    @NonNull
    @Override
    public MyApproval_AdvancePayment_Adapter.HOLDER onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_approval_advancepayment_unit,parent,false);
        HOLDER holder = new HOLDER(v);
        return holder ;
    }

    @Override
    public void onBindViewHolder(@NonNull MyApproval_AdvancePayment_Adapter.HOLDER holder, @SuppressLint("RecyclerView") int position) {
        status = new boolean[this.list.size()];
        for (int i=0;i<this.list.size();i++) {
            status[i] = false ;
        }
        Log.d("statusLength" ,list.size() +" "+status.length );
...
//                for(int i=0;i<MyApprovals.AdvancesOrdersAuthUsers.get(position).size();i++) {
//                    if (MyApp.db.getUser().id == MyApprovals.AdvancesOrdersAuthUsers.get(position).get(i).id) {
//                        //Auth a = new Auth();
//                        index = i ;
//                        isMyApprove = true ;
//                        break;
...
//                    for (int j = 0;j<MyApprovals.AdvancesOrdersAuthUsers.get(position).size();j++) {
//
...
//                }
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (status[position] == false) {
                        ...
                        if (MyApp.AdvancesOrdersAuthUsers.get(position).size()>0) {
                            for (int i = 0; i< MyApp.AdvancesOrdersAuthUsers.get(position).size(); i++) {
                                ...
                                holder.apps.get(i).setText(MyApp.AdvancesOrdersAuthUsers.get(position).get(i).FirstName+" "+MyApp.AdvancesOrdersAuthUsers.get(position).get(i).LastName);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (status[position] == false) {
                        status[position] = true ;
                        holder.icon.setImageResource(R.drawable.bring_up_icon);
                        if (MyApprovals.AdvancesOrdersAuthUsers.get(position).size()>0) {
                            for (int i = 0; i< MyApprovals.AdvancesOrdersAuthUsers.get(position).size(); i++) {
                                holder.layouts.get(i).setVisibility(View.VISIBLE);
                                holder.appsCaption.get(i).setText(MyApp.AdvancePaymentsAuthJobtitles.get(i).JobTitle);
                                holder.apps.get(i).setText(MyApprovals.AdvancesOrdersAuthUsers.get(position).get(i).FirstName+" "+MyApprovals.AdvancesOrdersAuthUsers.get(position).get(i).LastName);
                                holder.appsres.get(i).setText(list.get(position).Auths.get(i).getAuthResult());
                                holder.appsdate.get(i).setText(list.get(position).Auths.get(i).getAuthDate());
                                holder.appNotes.get(i).setText(list.get(position).Auths.get(i).Note);
                                if (list.get(position).Auths.get(i).getAuth() == 1) {
        ...
        holder.PDF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(holder.itemView.getContext(), AdvancePayment_Form.class);
    ...
    public class HOLDER extends RecyclerView.ViewHolder {
        ...
        public HOLDER(@NonNull View itemView) {
            ...
            name = (TextView) itemView.findViewById(R.id.avancePayment_name);
            icon = (ImageView) itemView.findViewById(R.id.imageView13);
            app1 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth1ID0);
            app1res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth1Res0);
            app1date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth1Date0);
            app2 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth2ID0);
            app2res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth2Res0);
            app2date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth2Date0);
            app3 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth3ID0);
            app3res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth3Res0);
            app3date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth3Date0);
            app4 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth4ID0);
            app4res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth4Res0);
            app4date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth4Date0);
            app5 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth5ID0);
            app5res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth5Res0);
            app5date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth5Date0);
            app6 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth6ID0);
            app6res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth6Res0);
            app6date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth6Date0);
            app7 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth7ID);
            app7res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth7Res);
            app7date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth7Date);
            app8 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth8ID);
            app8res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth8Res);
            app8date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth8Date);
            app9 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth9ID);
            app9res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth9Res);
            app9date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth9Date);
            app10 = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth10ID);
            app10res = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth10Res);
            app10date = (TextView) itemView.findViewById(R.id.MyApprovals_avancePayment_Auth10Date);
            ...
            reject = (Button)itemView.findViewById(R.id.avancePayment_reject);
            approve = (Button)itemView.findViewById(R.id.avancePayment_approve);
        }
    }
}

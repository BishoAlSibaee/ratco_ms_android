...
public class CustodyRequest_Adapter extends RecyclerView.Adapter<CustodyRequest_Adapter.HOLDER> {

    List<CUSTODY_REQUEST_CLASS> list = new ArrayList<CUSTODY_REQUEST_CLASS>();
    boolean[] status  ;
    String deleteCustodyUrl = MyApp.MainUrl + "deleteCustody.php";

    public CustodyRequest_Adapter(List<CUSTODY_REQUEST_CLASS> list) {
        this.list = list ;
    }

    @NonNull
    @Override
    public CustodyRequest_Adapter.HOLDER onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.hr_custody_request_unit,parent,false);
        HOLDER holder = new HOLDER(v);
        return holder ;
    }

    @Override
    public void onBindViewHolder(@NonNull CustodyRequest_Adapter.HOLDER holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!status[position] ) {
                    if (MyApp.CustodyAuthUsers.size()>0) {
                        holder.icon.setImageResource(R.drawable.bring_up_icon);
                        for (int i = 0; i< MyApp.CustodyAuthUsers.size(); i++) {
                            ...
                            holder.apps.get(i).setText(MyApp.CustodyAuthUsers.get(i).FirstName+" "+MyApp.CustodyAuthUsers.get(i).LastName);
            ...
            public boolean onLongClick(View v) {
                ...
                b.setTitle(holder.itemView.getContext().getResources().getString(R.string.areYouSure))
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                StringRequest req = new StringRequest(Request.Method.POST, deleteCustodyUrl, new Response.Listener<String>() {
                                    @Override
    ...
    public class HOLDER extends RecyclerView.ViewHolder {
        TextView Order , Amount , Date , Reason , app1,app1res,app1date,app1Note,app2,app2res,app2date,app2Note,app3,app3res,app3date,app3Note,app4,app4res,app4date,app4Note,app5,app5res,app5date,app5Note,app6,app6res,app6date,app6Note,app7,app7res,app7date,app7Note,app8,app8res,app8date,app8Note,app9,app9res,app9date,app9Note,app10,app10res,app10date,app10Note ;

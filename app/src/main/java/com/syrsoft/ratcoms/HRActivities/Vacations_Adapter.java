...
public class Vacations_Adapter extends RecyclerView.Adapter<Vacations_Adapter.HOLDER> {

    List<VACATION_CLASS> list = new ArrayList<VACATION_CLASS>();
    boolean[] status  ;
    String deleteVacationUrl = MyApp.MainUrl + "deleteVacation.php";

    public Vacations_Adapter(List<VACATION_CLASS> list) {
        this.list = list;
    }

    @NonNull
    @Override
    public Vacations_Adapter.HOLDER onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.vacation_unit,parent,false);
        HOLDER holder = new HOLDER(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull Vacations_Adapter.HOLDER holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.type.setText(list.get(position).getVacationType());
        for (int i=0 ; i< list.get(position).Auths.size();i++) {
                //holder.apps.get(i).setVisibility(View.GONE);
                //holder.appsres.get(i).setVisibility(View.GONE);
                //holder.appsdate.get(i).setVisibility(View.GONE);
                //holder.appsCaption.get(i).setVisibility(View.GONE);
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!status[position]) {
                    if (MyApp.VacationsAuthUsers.size()>0) {
                        holder.icon.setImageResource(R.drawable.bring_up_icon);
                        for (int i=0 ; i< MyApp.VacationsAuthUsers.size();i++) {
                            ...
                            holder.apps.get(i).setText(MyApp.VacationsAuthUsers.get(i).FirstName+" "+MyApp.VacationsAuthUsers.get(i).LastName);
                        ...
                        ToastMaker.Show(0,"No Auths For Vacations" ,holder.itemView.getContext());
                    }
                }
                else {
            ...
            public boolean onLongClick(View v) {
                ...
                b.setTitle(holder.itemView.getContext().getResources().getString(R.string.areYouSure))
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                StringRequest req = new StringRequest(Request.Method.POST, deleteVacationUrl, new Response.Listener<String>() {
                                    @Override
                                    public void onResponse(String response) {
                                        if (response.equals("1")) {
                                            HR_Orders.getVacations();
                                        }
                                        else {
    ...
    public class HOLDER extends RecyclerView.ViewHolder {
        TextView order , start , days , type , app1,app1res,app1date,app2,app2res,app2date,app3,app3res,app3date,app4,app4res,app4date,app5,app5res,app5date,app6,app6res,app6date,app7,app7res,app7date,app8,app8res,app8date,app9,app9res,app9date,app10,app10res,app10date,app1Note,app2Note,app3Note,app4Note,app5Note,app6Note,app7Note,app8Note,app9Note,app10Note;
        ...
        public HOLDER(@NonNull View itemView) {
            ...
            app1 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth1ID0);
            app1res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth1Res0);
            app1date = (TextView) itemView.findViewById(R.id.MyVacationUnit_Auth1Date0);
            app1Caption = (TextView)itemView.findViewById(R.id.textView27);
            app2 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth2ID);
            app2res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth2Res);
            app2date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth2Date);
            app2Caption = (TextView) itemView.findViewById(R.id.textView24);
            app3 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth3ID);
            app3res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth3Res);
            app3date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth3Date);
            app3Caption = (TextView) itemView.findViewById(R.id.textView270);
            app4 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth4ID);
            app4res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth4Res);
            app4date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth4Date);
            app4Caption = (TextView) itemView.findViewById(R.id.textView240);
            app5 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth5ID);
            app5res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth5Res);
            app5date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth5Date);
            app5Caption = (TextView) itemView.findViewById(R.id.textView271);
            app6 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth6ID);
            app6res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth6Res);
            ...
            app7 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth7ID);
            app7res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth7Res);
            app7date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth7Date);
            app7Caption = (TextView) itemView.findViewById(R.id.textView2715);
            app8 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth8ID);
            app8res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth8Res);
            app8date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth8Date);
            app8Caption = (TextView) itemView.findViewById(R.id.textView2415);
            app9 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth9ID);
            app9res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth9Res);
            app9date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth9Date);
            app9Caption = (TextView) itemView.findViewById(R.id.textView2714);
            app10 = (TextView) itemView.findViewById(R.id.VacationUnit_Auth10ID);
            app10Caption = (TextView) itemView.findViewById(R.id.textView2414);
            app10res = (TextView) itemView.findViewById(R.id.VacationUnit_Auth10Res);
            app10date = (TextView) itemView.findViewById(R.id.VacationUnit_Auth10Date);
            ...
            icon = (ImageView) itemView.findViewById(R.id.imageView9);
        }
    }
}
